...
//        return CLLocation(latitude: 43.010449, longitude: -81.1975784)
        return CLLocation(latitude: 43.0130, longitude: -81.1994) //fanshawe coordinates
    }
    ...
    private func addAnnotation(location: CLLocation) {
        let annotation = MyAnnotation(coordinate: location.coordinate, title: "You are here!", subtitle:"your current location.", glyphText:"F")
